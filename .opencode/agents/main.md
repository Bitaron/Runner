...
1. **Phase 1: Startup Safety Validation**:
   ...
   - If it flags system boot crashes, pass execution logs directly to `startup_error_solve`.
...
2. **Phase 2: Core Workspace Analysis**:
   ...
   - Spin up the application services to surface application bugs: `npm run start:services`
